...
import { HubButton, HubButtonDescription, HubButtonTitle } from "../../../presentation/components/HubButton";
...
export const StudentReports = () => (
    <HubLayout title="Reportes de Estudiantes">
        ...
        <HubButton icon={<AssignmentIndIcon />} url="/students/reports/registration">
