...
export const StudentEdit = () => {
  return (
    <Edit mutationMode="pessimistic" title={<span style={{ fontWeight: 600, fontSize: "1.1rem", letterSpacing: "0.05em", textTransform: "uppercase", color: "#fff" }}>Editar Estudiante</span>}>
