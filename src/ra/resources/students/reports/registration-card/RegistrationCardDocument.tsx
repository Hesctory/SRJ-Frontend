...
const fullName = (...parts: (string | undefined)[]) => parts.filter(Boolean).join(" ");
...
const ParentTable = ({ data = {} }: { data?: Parent }) => (
    <>
        <Row>
            ...
            <Cell span={3}>{fullName(data.paternalLastName, data.maternalLastName)}</Cell>
    ...
    return (
        <Page size="A4" style={styles.page}>
            ...
            <View style={styles.infoRow}>
                <Text style={styles.infoCell}>Fecha Matrícula: {str(s.enrollmentDate)}</Text>
            ...
            <Row>
                <Cell header>Apellidos</Cell>
                <Cell span={3}>{fullName(guardian.paternalLastName, guardian.maternalLastName)}</Cell>
                <Cell header>Nombres</Cell>
            ...
            <View style={styles.observationBox}>
                <Text style={{ fontFamily: "Helvetica-Bold", fontSize: 7 }}>OBSERVACIÓN</Text>
            </View>
...
export const RegistrationCardDocument = ({ students }: Props) => (
    <Document>
        {students.length === 0 ? (
            <Page size="A4" style={styles.page}>
                <Text style={{ marginTop: 40, textAlign: "center", color: "#888888", fontSize: 9 }}>
