...
interface GenerateButtonProps {
    onResult: (students: RegistrationCardStudent[], ctx: RegistrationCardContext) => void;
}
...
const StudentSelectionList = ({ filterKey, onResult }: StudentSelectionListProps) => (
    <Box sx={{ mt: 3 }}>
...
const RegistrationCardForm = ({ onResult }: RegistrationCardFormProps) => {
    ...
    const filterKey = [schoolYearId, levelId, gradeId, shiftId, sectionId, dni, fullName]
        .filter(Boolean)
        .join("|");
