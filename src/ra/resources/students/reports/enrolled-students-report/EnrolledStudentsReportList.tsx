                ...
                <CardContent>
                    ...
                    <Box sx={{ display: "flex", flexWrap: "wrap", gap: 2, mt: 1 }}>
                        ...
                        <FormControl sx={{ minWidth: 160 }} size="small">
                            ...
                            <Select value={selectedLevel} label="Nivel" onChange={handleLevel}>
                                <MenuItem value=""><em>Todos</em></MenuItem>
                                {levels.map((lv: any) => (
                        ...
                        {/* Grado */}
                        <FormControl sx={{ minWidth: 160 }} size="small" disabled={!selectedLevel}>
                            <InputLabel>Grado</InputLabel>
                            <Select value={selectedGrade} label="Grado" onChange={handleGrade}>
                                <MenuItem value=""><em>Todos</em></MenuItem>
                                {grades.map((g: any) => (
                        ...
                        {/* Sección */}
                        <FormControl sx={{ minWidth: 140 }} size="small" disabled={!selectedGrade}>
