...
interface SchoolYear { id: string | number; year: string }
interface AcademicLevel { id: string | number; name: string }
interface Grade { id: string | number; name: string }
interface Shift { id: string | number; name: string }
interface Section { id: string | number; section: string }
