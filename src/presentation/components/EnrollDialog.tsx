...
import { Form, useDataProvider, useNotify, useRedirect, Identifier } from "react-admin";
...
export const EnrollDialog = ({ open, onClose, studentData, studentId }: EnrollDialogProps) => {
    ...
    const handleSubmit = async (enrollmentData: Record<string, unknown>) => {
        try {
            ...
            notify(`Error al matricular el estudiante: ${message}`, { type: 'error' });
        }
    };
