...
const DisabilityForm = () => {
    ...
    const hasDisabilityCertificate = useWatch({ name: "hasDisabilityCertificate" });
    ...
    return (
        <>
            ...
            <ReferenceInput source="disabilityTypeId" reference="disability-types">
                <SelectInput label="Tipo de discapacidad" disabled={!hasDisability} optionText="type" />
            </ReferenceInput>
            <ReferenceInput source="disabilityDegreeId" reference="disability-degrees">
                <SelectInput label="Grado de discapacidad" disabled={!hasDisability} optionText="degree" />
            </ReferenceInput>
            <TextInput
