...
export const EnrolledStudentsReport = ({ students, schoolYear }: EnrolledStudentsReportProps) => (
    <Document>
            ...
            <View style={styles.table}>
                ...
                {students.map((student, index) => (
                    ...
                    >
                        ...
                        <Text style={[styles.cell, styles.colCode]}>{student.studentCode}</Text>
                        ...
                        <Text style={[styles.cell, styles.colSection]}>{student.section}</Text>
                    </View>
                ))}
            </View>
